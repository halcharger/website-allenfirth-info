    ...
    <>
      ...
      >
        <div className="space-y-20">
          <ExperienceSection
            title="Jul 2022 - Mar 2025"
            subTitle="Digiterre Consultant Developer"
          >
            <Contract
              title="Uniper - PPA Model Valuation Desktop"
              event="Lodon, UK - Fully Remote"
            >
              <p>
            ...
            <Contract title="corfinancial - bitarisk - private client portfolio management">
              <p>
            ...
            <Contract title="London Stock Exchange Group - Municipal Market Monitor">
              <p>
                As a <strong>Digiterre</strong> consultant I worked on a team
          ...
          <ExperienceSection
            title="2017 - 2021"
            subTitle="CodeStream Consultant Developer"
          >
            <Contract
